...
- Add Swagger or Redoc API documentation for Django restful API endpoints (Write down well-organized and well-documented API references)
- Create a new repository to your personal git and commit the result.


# Note
- Added swagger on every route with the tags
- Removed stripe key 
- Attach a screenshot link of swagger

Link: https://prnt.sc/cIDrDNzAEu8Q
